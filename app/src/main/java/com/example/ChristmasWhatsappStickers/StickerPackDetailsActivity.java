...
public class StickerPackDetailsActivity extends AddStickerPackActivity implements View.OnClickListener {
    ...
    private void onClickListener(StickerPackDetailsActivity stickerPackDetailsActivity) {
        findViewById(R.id.back_icon).setOnClickListener(stickerPackDetailsActivity);
    }
