...
public class StickerPackListActivity extends AddStickerPackActivity {
    ...
    private void recalculateColumnCount() {
        ...
        if (viewHolder != null) {
            ...
            Log.e("Log 2", "" + maxNumberOfImagesInARow);
            int minMarginBetweenImages = (widthOfImageRow - maxNumberOfImagesInARow * previewSize) / (maxNumberOfImagesInARow);
            Log.e("Log 3", "" + minMarginBetweenImages);
            allStickerPacksListAdapter.setImageRowSpec(5, minMarginBetweenImages);
        }
    }
